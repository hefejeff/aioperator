      ...
      <section className="px-4 sm:px-6 md:px-8 pt-12 sm:pt-16 md:pt-20 pb-8">
        <div className="max-w-5xl mx-auto">
          <div className="text-center">
            <div className="w-fit mx-auto text-sky-400"><Icons.Sparkles /></div>
          ...
          <div className="mt-8 bg-slate-900/70 border border-slate-700 rounded-2xl shadow-2xl p-4 sm:p-6 md:p-8">
              ...
              <div>
                ...
                <div className="mt-3 grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <div className="flex items-center gap-2">
                    <span className="text-slate-300 text-sm">{t('landing.platform.label')}:</span>
                    <select
                      value={platform}
                      onChange={(e)=> setPlatform(e.target.value as Platform)}
                      className="bg-slate-950 border border-slate-700 text-slate-200 rounded px-2 py-1 w-full"
                  ...
                  <div className="flex flex-col gap-2">
                    <div className="flex items-center gap-2">
                      <span className="text-slate-300 text-sm">{t('landing.domain.label')}:</span>
                      <select
                        value={domainChoice}
