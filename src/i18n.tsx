...
export const resources: Record<string, Record<string, string>> = {
  ...
  'dashboard.weeksAgo': '{{count}} weeks ago',
    ...
    'workflowDetail.scenario': 'Use Case',
  ...
  'workflowDetail.noScenario': 'Use case details unavailable.',
  ...
  'research.selectedScenarios': 'Selected Use Cases',
  'research.suggestSelected': 'Suggest Selected',
  'research.removeFromSelected': 'Remove from selected',
  'research.noSelectedScenarios': 'No use cases selected',
  'research.noScenariosYet': 'No use cases yet',
  'research.searchCompanyFirst': 'Search for a company first',
  'research.noCompanyToSaveScenarios': 'No company available to save use cases',
  'research.readOnlyMode': 'Viewing in read-only mode - selections not saved',
  'research.failedToSaveScenarios': 'Failed to save use case selections',
  'research.suggested': 'Suggested',
  'research.relevanceMatch': 'Relevance Match',
  'research.viewScenario': 'View Use Case',
  ...
  'research.createScenario': 'Create Use Case',
  'research.suggestOpportunity': 'Suggest Opportunity',
  'research.manualScenarioReason': 'Created for this company',
  'research.scenarioRuns': 'Use Case Runs',
  'research.noScenarioRuns': 'No use case runs yet',
  'research.confirmDeleteRun': 'Are you sure you want to delete this use case run? This cannot be undone.',
  'research.unknownScenario': 'Unknown Use Case',
  ...
  'research.runScore': 'Score {{score}}',
    'research.documentUpload': 'Document Upload',
    'research.documentUploadHint': 'Upload up to 5 documents (PDF, Word, or text files)',
    'research.document': 'Document',
    'research.documentLink': 'View uploaded document',
    'research.documentUploading': 'Uploading document...',
    'research.documentUploadSuccess': 'Document successfully uploaded and attached to company',
    'research.documentUploadError': 'Error uploading document',
    'research.documentNoCompany': 'Please select a company before uploading a document',
    'research.documentInvalidType': 'Invalid file type. Please upload a PDF, Word, or text file',
    'research.documentDelete': 'Delete document',
    'research.documentDeleteConfirm': 'Are you sure you want to delete this document?',
    'research.documentMaxReached': 'Maximum of 5 documents allowed. Delete one to upload more.',
    'research.documentsCount': '{{count}} of 5 documents uploaded',
    'research.documentClickToUpload': 'Click to upload',
    'research.documentOrDragDrop': 'or drag and drop',
    // Legacy RFP translations (for backward compatibility)
    'research.rfpUpload': 'Document Upload',
    'research.rfpUploadHint': 'Upload up to 5 documents (PDF, Word, or text files)',
    'research.rfpDocument': 'Document',
    'research.rfpDocumentLink': 'View uploaded document',
    'research.rfpUploading': 'Uploading document...',
    'research.rfpUploadSuccess': 'Document successfully uploaded and attached to company',
    'research.rfpUploadError': 'Error uploading document',
    'research.rfpNoCompany': 'Please select a company before uploading a document',
    'research.rfpInvalidType': 'Invalid file type. Please upload a PDF, Word, or text file',
    'research.rfpDelete': 'Delete document',
    'research.rfpDeleteConfirm': 'Are you sure you want to delete this document?',
  ...
  'operator.historyTitle': 'Use Case Runs',
  'operator.noHistoryScenario': 'You have not run this use case yet.',
  ...
  'operator.invalidImageAlert': 'Please upload a valid image file',
    ...
    'common.error': 'Error',
    'common.errorDeleting': 'Failed to delete. Please try again.',
  ...
  'dashboard.noWorkflowsDesc': 'Run a use case to capture your first workflow history.',
  'dashboard.scenarios': 'Use Cases',
  ...
  'landing.cta.createFirst': 'Create your first use case',
  ...
  'landing.highlights.2.desc': 'Share use cases, gather feedback, and version workflows as you iterate.',
  ...
  'scenario.delete': 'Delete use case',
  'scenario.highScore': 'High score',
  'scenario.avgScore': 'Average score',
  'scenario.start': 'Create use case',
  ...
  'dashboard.weeksAgo': 'Hace {{count}} semanas',
    ...
    'workflowDetail.scenario': 'Caso de Uso',
  ...
  'workflowDetail.noScenario': 'Detalles del caso de uso no disponibles.',
  ...
  'research.removeFromSelected': 'Quitar de seleccionados',
    ...
    'research.viewScenario': 'Ver caso de uso',
    ...
    'research.createScenario': 'Crear caso de uso',
    'research.suggestOpportunity': 'Sugerir oportunidad',
  'research.manualScenarioReason': 'Creado para esta empresa',
    'research.scenarioRuns': 'Ejecuciones de casos de uso',
    'research.noScenarioRuns': 'No hay ejecuciones de casos de uso aún',
    'research.confirmDeleteRun': '¿Estás seguro de que deseas eliminar esta ejecución de caso de uso? Esta acción no se puede deshacer.',
    'research.unknownScenario': 'Caso de uso desconocido',
    ...
    'form.workflow.title': 'Crear Nuevo Proceso',
    'form.domain': 'Dominio',
    ...
    'loading': 'Cargando...',
  'operator.back': 'Volver a los casos de uso',
  ...
  'operator.historyTitle': 'Ejecuciones del caso de uso',
  'operator.noHistoryScenario': 'Todavía no has ejecutado este caso de uso.',
  ...
  'operator.invalidImageAlert': 'Por favor suba un archivo de imagen válido',
    ...
    'common.error': 'Error',
    'common.errorDeleting': 'No se pudo eliminar. Por favor, inténtalo de nuevo.',
    ...
    'dashboard.noWorkflowsDesc': 'Ejecuta un caso de uso para capturar el historial de tu primer flujo de trabajo.',
    'dashboard.scenarios': 'Casos de Uso',
    ...
    'landing.cta.createFirst': 'Crea tu primer caso de uso',
    ...
    'landing.highlights.2.desc': 'Comparte casos de uso, reúne comentarios y versiona los flujos mientras iteras.',
    ...
    // Entrenamiento
    'training.title': 'Procesos y Casos de Uso',
    'training.subtitle': 'Practica con flujos de IA curados o crea los tuyos.',
    'training.createButton': 'Crear proceso',
