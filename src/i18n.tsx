...
const resources: Record<string, Record<string, string>> = {
  ...
  'aiExample.clear': 'Clear',
    ...
    // Operator console
    'operator.back': 'Back',
  'operator.design': 'Proposed Workflow',
    'operator.explain': 'Explain Your Proposed Workflow',
    'operator.visual': 'Proposed Visual Workflow (Optional)',
  ...
  'operator.explainHelper': 'Describe the steps in your process, taking into account any existing workflow image. Specify which tasks are handled by AI and which require human intervention.',
    'operator.yourGoalLabel': 'Your Goal:',
    'operator.yourScore': 'Your Score',
    'operator.aiFeedback': 'Feedback from AI Consultant:',
  'operator.aiAssist': 'AI Assist: draft explanation based on current workflow',
  ...
  'training.title': 'Workflow Library',
  ...
  'modalActions.save': 'Save Document',
  'modalActions.download': 'Download as MD',
  'modalActions.copy': 'Copy to Clipboard',
  'modalActions.close': 'Close Window',
  'prd.generateShort': 'Generate PRD',
  'pitch.generateShort': 'Create Pitch',
  ...
  'landing.problem.subtitle': 'Turn your ideas into smart workflows - We will guide you through building AI-powered solutions that work for you',
  ...
  'modalActions.save': 'Guardar Documento',
  'modalActions.download': 'Descargar como MD',
  'modalActions.copy': 'Copiar al Portapapeles',
  'modalActions.close': 'Cerrar Ventana',
