...
export const ALL_SCENARIOS: Scenario[] = [
  ...
  title_es: 'Automatizando la Clasificación de Soporte al Cliente',
    description: 'Design a workflow to manage incoming customer support tickets, deciding which stages to automate with AI and when to escalate to a human agent.',
  description_es: 'Diseña un flujo de trabajo para gestionar tickets de soporte entrantes, decidiendo qué pasos automatizar con IA y cuándo escalar a un agente humano.',
    goal: "You're given a sample customer support email. First, define a process flow (e.g., categorize intent, check urgency, draft response, decide on escalation). Identify which stages are best for an AI vs. a human. Then, for an AI-suitable stage like 'Categorize and Summarize', write a prompt that takes the email and outputs a structured summary (e.g., JSON with category, urgency, and a one-sentence summary).",
  ...
  title_es: 'Canal de Contenido: De la Transcripción al Post del Blog',
    description: 'Create a workflow to turn a raw meeting transcript into a polished blog post, strategically using AI for stages like summarization and drafting while reserving others for human oversight.',
  description_es: 'Crea un flujo para convertir una transcripción cruda de reunión en un post de blog pulido, usando IA estratégicamente para pasos como resumen y redacción mientras se reserva la revisión humana para otros.',
    goal: "You are given a messy meeting transcript. First, define the stages to get from transcript to blog post (e.g., cleaning, summarizing, outlining, drafting, human review). Which stages are ideal for AI? Then, write a prompt for a core AI stage: taking a cleaned summary of the meeting and generating a structured outline for a blog post, complete with a catchy title and section headers.",
...
export const Icons = {
  Copy: (props: React.SVGProps<SVGSVGElement>) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" className={`h-5 w-5 ${props.className || ''}`} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
  ...
  Star: (props?: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={props?.className || "h-5 w-5"} viewBox="0 0 20 20" fill="none" stroke="currentColor" strokeWidth={1.5}>
  ...
  ChevronRight: (props: React.SVGProps<SVGSVGElement>) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className={props.className || "h-5 w-5"}>
  ...
  CheckSquare: ({ className, ...props }: React.SVGProps<SVGSVGElement>) => (
    <svg
      {...props}
  ...
  Square: ({ className, ...props }: React.SVGProps<SVGSVGElement>) => (
    <svg
      {...props}
      className={`h-5 w-5${className ? ` ${className}` : ''}`}
      xmlns="http://www.w3.org/2000/svg"
  ...
  X: (props: React.SVGProps<SVGSVGElement>) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" className={`h-6 w-6 ${props.className || ''}`} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
